...
namespace ECSPhysics2D.Samples.FallingCascade
{
  ...
  /// </summary>
  public class FallingCascadeChainBaker : Baker<FallingCascadeChainAuthoring>
  {
    public override void Bake(FallingCascadeChainAuthoring authoring)
    {
      ...
      // Terrain tag for collision response system
      AddComponent<TerrainTag>(entity);
    }

    private NativeArray<float2> GenerateChainVertices(FallingCascadeChainAuthoring authoring)
    {
    ...
    private CollisionFilter ParseCollisionFilter(FallingCascadeChainAuthoring authoring)
    {
